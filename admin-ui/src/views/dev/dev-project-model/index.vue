...
<div class="my-layout">
      ...
      <el-row>
        <el-col :span="18" :xs="24" class="my-search-box-inputs">
          <el-form :inline="true" label-width="auto" @submit.stop.prevent>
            ...
            <el-form-item class="my-search-box-item"  label="模型名称">
              <el-input  clearable  v-model="state.filter.name" placeholder="" @keyup.enter="onQuery" >
              </el-input>
            </el-form-item>
            <el-form-item class="my-search-box-item"  label="模型编码">
    ...
    <el-card class="my-fill mt8" shadow="never">
      <el-table v-loading="state.loading" :data="state.devProjectModelListData" row-key="id"  ref="listTableRef" @row-click="listTableToggleSelection"  @selection-change="selsChange">
